            ...
            while ((data = buffReader.readLine()) != null) {
                ...
                if (data.trim().contains("##@externaldata")) {
                    ...
                    if(filePath.contains("@")) {
                    	...
                    	sheetName = data.substring(data.lastIndexOf("@")+1, data.length());// if file is xlsx , need to pass sheet name
                    }
                ...
                if (foundHashTag) {
                    excelData = FileReaderHelper.getFileData(filePath, sheetName);
